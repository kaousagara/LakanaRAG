...
class QueryParam:
    ...
    - "analyste": Works like hybrid mode but uses an analytical committee prompt.
    - "deepsearch": Performs a multi step retrieval using Tree of Thought.
    """
    ...
    page: int = 1
    """Result page number for pagination. Starts from 1."""
